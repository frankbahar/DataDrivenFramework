...
public class TestConfig{
	...
	public static String from = "fikretbahar@gmail.com";
	public static String password = "Kadriye56";
	public static String[] to ={"frankbahar07@gmail.com","fikretbahar@yahoo.com"};
